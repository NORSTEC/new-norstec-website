...
export default function SectionTextImage({ section }: SectionTextImageProps) {
    ...
    return (
        <section className="relative min-h-screen xl:h-screen">
            <StripesVertical className="hidden md:flex pl-[7vw] 3xl:pl-[15rem]"/>

            <div className="flex flex-col md:flex-row h-full min-h-screen items-start relative z-10 px-[20px] md:px-[40px]">
                <div className="md:min-w-[30vw]  3xl:pl-[3vw] 3xl:min-w-[40rem] bg-egg py-10">
                    {title && <h2 className="text-h2 italic">{title}</h2>}
                </div>

                <div className="md:py-10 bg-egg md:pl-[8vw] 2xl:pl-[2vw] flex flex-col justify-center h-full min-h-screen">
                    <div className="flex-1 flex items-center h-full md:pt-[5vh] order-1 md:order-2">
