    ...
    return (
        ...
        <main className="w-full stripes-right mobile-container relative">
            ...
            <header className="mb-10">
                <h1 className="text-h2">Privacy Policy
                    <span
                        aria-hidden
            ...
            <section className="mb-10">
                <p className="text-base leading-relaxed">
                    NORSTEC respects your privacy and is committed to protecting your
            ...
            <div className="space-y-10">
                ...
                <PolicySection title="3. Newsletter subscriptions">
                    <p className="text-moody leading-relaxed">
                        ...
                        news, and marketing communications from NORSTEC.
                    </p>
                ...
                <PolicySection title="4. Third-party services">
                    ...
                    <p className="mt-2 text-moody leading-relaxed">
                        ...
                        collect information about your device and behavior to determine whether you are a human
                        user.
                    </p>
                ...
                <PolicySection title="5. Legal basis for processing">
                    ...
                    <ul className="mt-4 list-disc pl-5 space-y-2 text-moody leading-relaxed">
                        ...
                        <li>
                            <span className="font-medium text-moody">Legitimate interest</span> (site security and
                            abuse prevention)
                        </li>
                    </ul>
