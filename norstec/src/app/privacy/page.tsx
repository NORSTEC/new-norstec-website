        ...
        <div className="space-y-10">
          ...
          <PolicySection title="2. What personal data we collect">
            <ul className="list-disc pl-5 space-y-2 text-moody leading-relaxed">
              ...
              <li>
                Contact details, place of study and information about your activity and budget (when
                you apply for ESA funding)
              </li>
              <li>
                Name, email address and your message (when you apply for a position in NORSTEC)
              </li>
          ...
          <PolicySection title="4. ESA funding applications">
            <p className="text-moody leading-relaxed">
              When you apply for funding for an ESA course or conference, the information you enter
              in the form and any attachments are sent by email to NORSTEC&apos;s finance team
              (economy@norstec.no). We use the information to process your application, pay out any
              funding and report to the Norwegian Space Agency.
            </p>
          ...
          <PolicySection title="5. Applications for positions">
            <p className="text-moody leading-relaxed">
              When you apply for a position in NORSTEC, your name, email address, the position and
              your message are sent by email to our recruitment team (join@norstec.no) and stored in
              an internal Google Sheets spreadsheet. We use the information only to process your
              application and contact you about it.
            </p>

            <ul className="mt-4 list-disc pl-5 space-y-2 text-moody leading-relaxed">
              <li>You must actively consent before submitting an application</li>
              <li>Only the people handling recruitment have access to the information</li>
              <li>
                You can ask us to delete your application at any time by contacting join@norstec.no
              </li>
            </ul>
          </PolicySection>
          ...
          <PolicySection title="7. Legal basis for processing">
            ...
            <ul className="mt-4 list-disc pl-5 space-y-2 text-moody leading-relaxed">
              <li>
                ...
                and applications for positions)
              </li>
              <li>
          ...
          <PolicySection title="8. How long we store your data">
            <p className="text-moody leading-relaxed">
            ...
            <ul className="mt-4 list-disc pl-5 space-y-2 text-moody leading-relaxed">
              ...
              <li>
                Applications for positions are deleted when the recruitment process for the position
                is completed, and no later than six months after
              </li>
